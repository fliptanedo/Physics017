...
\newtheorem{newrule}{Rule}[section]
\AtBeginEnvironment{newrule}{\footnotesize}
\tcolorboxenvironment{newrule}{
...
\newcommand{\sgn}{\operatorname{\textnormal{sgn}}}

% Referencing equations inside theorem-like environments
