...
Let us observe that the rule we proposed ***\bigidearef{}~\ref{idea:transformation:of:upper:and:lower:indices}
...
For more introductory references on how this structure appears in ordinary mechanics, I refer to two really neat graduate-level textbooks in Fig.~\ref{fig:figure:mathematical:physics:books}.
\begin{marginfigure}%[th]
